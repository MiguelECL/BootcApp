...
class ProductsManagementServiceImplTest {
  ...
  @Test
  void test_getProducts_TimeoutException() throws TimeoutException {
    ...
    Message mockResponse = new Message().withBody("Invalid JSON");
  ...
  @Test
  void test_getProducts_JsonException() throws TimeoutException, JsonProcessingException {
    ...
    verify(mockRequester).sendMessageAndGetResponse(mockRequest, 0, TimeUnit.SECONDS);
  ...
  @Test
  void test_createProduct_TimeoutException() throws TimeoutException, JsonProcessingException {
    Product product = new Product(1, "test_product", "test_description", 10.0f, Date.valueOf("2023-10-01"));
    String productJson = "{\"id\":1,\"name\":\"test_product\",\"description\":\"test_description\",\"price\":10.0,\"createDate\":\"2023-10-01\"}";
    ...
    SendMessageRequest mockRequest = new SendMessageRequest()
            .withMessageAttributes(messageAttributes)
            .withMessageBody(productJson);

    when(mockRequester.sendMessageAndGetResponse(mockRequest, 0, TimeUnit.SECONDS))
  ...
  @Test
  void test_createProduct_JsonException() throws JsonProcessingException, TimeoutException {
    Product product = new Product(1, "test_product", "test_description", 10.0f, Date.valueOf("2023-10-01"));
  ...
  @Test
  void test_createProduct_ReadValueJsonException() throws JsonProcessingException, TimeoutException {
    Product product = new Product(1, "test_product", "test_description", 10.0f, Date.valueOf("2023-10-01"));
    String productJson = "{\"id\":1,\"name\":\"test_product\",\"description\":\"test_description\",\"price\":10.0,\"createDate\":\"2023-10-01\"}";
    ...
    Message mockResponse = new Message().withBody(productJson);

    when(mockRequester.sendMessageAndGetResponse(mockRequest, 0, TimeUnit.SECONDS))
            .thenReturn(mockResponse);
    when(objectMapper.writeValueAsString(product)).thenReturn(productJson);
    when(objectMapper.readValue(productJson, Product.class)).thenThrow(new JsonProcessingException("") {});
  ...
  @Test
  void test_updateProduct_Success() throws JsonProcessingException, TimeoutException {
    Product product = new Product(1, "test_product", "test_description", 10.0f, Date.valueOf("2023-10-01"));
    String productJson = "{\"id\":1,\"name\":\"test_product\",\"description\":\"test_description\",\"price\":10.0,\"createDate\":\"2023-10-01\"}";
  ...
  @Test
  void test_updateProduct_DatabaseException() throws JsonProcessingException, TimeoutException {
    Product product = new Product(1, "test_product", "test_description", 10.0f, Date.valueOf("2023-10-01"));
    String productJson = "{\"id\":1,\"name\":\"test_product\",\"description\":\"test_description\",\"price\":10.0,\"createDate\":\"2023-10-01\"}";
    ...
    Message mockResponse = new Message().withBody("Failure to update from database");
    when(mockRequester.sendMessageAndGetResponse(mockRequest, 0, TimeUnit.SECONDS)).thenReturn(mockResponse);

    assertThrows(DatabaseException.class, () -> service.updateProduct(product));
  }

  @Test
  void test_updateProduct_TimeoutException() throws JsonProcessingException, TimeoutException {
    Product product = new Product(1, "test_product", "test_description", 10.0f, Date.valueOf("2023-10-01"));
    String productJson = "{\"id\":1,\"name\":\"test_product\",\"description\":\"test_description\",\"price\":10.0,\"createDate\":\"2023-10-01\"}";
  ...
  @Test
  void test_updateProduct_DeserializationException() throws JsonProcessingException, TimeoutException {
    Product product = new Product(1, "test_product", "test_description", 10.0f, Date.valueOf("2023-10-01"));
    String productJson = "{\"id\":1,\"name\":\"test_product\",\"description\":\"test_description\",\"price\":10.0,\"createDate\":\"2023-10-01\"}";
    ...
    Message mockResponse = new Message().withBody("Response");
    when(mockRequester.sendMessageAndGetResponse(mockRequest, 0, TimeUnit.SECONDS)).thenReturn(mockResponse);
    when(objectMapper.readValue("Response", Product.class)).thenThrow(new JsonProcessingException("") {});
  ...
  @Test
  void test_deleteProduct_TimeoutException() throws TimeoutException {
    int id = 1;
    Map<String, MessageAttributeValue> messageAttributes = new HashMap<>();
    messageAttributes.put("action", new MessageAttributeValue()
            .withDataType("String")
    ...
    when(mockRequester.sendMessageAndGetResponse(request,0, TimeUnit.SECONDS)).thenThrow(new TimeoutException("E"));
  ...
  @Test
  void test_deleteProduct_DatabaseException() throws TimeoutException {
    int id = 1;
    Map<String, MessageAttributeValue> messageAttributes = new HashMap<>();
    messageAttributes.put("action", new MessageAttributeValue()
            .withDataType("String")
    ...
    Message mockResponse = new Message().withBody("Failure to delete from database");
    when(mockRequester.sendMessageAndGetResponse(request,0, TimeUnit.SECONDS)).thenReturn(mockResponse);

    assertThrows(DatabaseException.class, ()-> service.deleteProduct(id));
